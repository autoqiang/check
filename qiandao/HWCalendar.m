...
#import "Person.h"
#define KCol 7
#define KBtnW [[UIScreen mainScreen]bounds].size.width*4/35
#define KBtnH [[UIScreen mainScreen]bounds].size.width*4/35
#define KMaxCount 37
#define KBtnTag 100
#define KTipsW [[UIScreen mainScreen]bounds].size.width/5
#define KShowYearsCount 100
#define KMainColor [UIColor colorWithRed:39/255.0 green:148/255.0 blue:252/255.0 alpha:1]
#define KbackColor [UIColor colorWithRed:130/255.0 green:194/255.0 blue:253/255.0 alpha:1]
#define kgreencolor [UIColor colorWithRed:92/255.0 green:200/255.0 blue:151/255.0 alpha:1]
#define klightgreencolor [UIColor colorWithRed:168/255.0 green:216/255.0 blue:185/255.0 alpha:1]
...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        //创建控件
        [self creatControl:_colornumber];
...
- (void)creatControl:(NSNumber *)number
{
    //左侧显示视图
    UIView *tipsView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, KTipsW, 396)];
    if ([_colornumber integerValue]==1) {
        tipsView.backgroundColor = kgreencolor ;
    }else{
...
//    weekLabel.backgroundColor = [UIColor colorWithRed:39/255.0 green:148/255.0 blue:252/255.0 alpha:1];
    if ([_colornumber integerValue]==1) {
        weekLabel.backgroundColor = kgreencolor ;
    }else{
        weekLabel.backgroundColor = KMainColor;
    }
    ...
    dayLabel.font = [UIFont systemFontOfSize:46.0f];
    ...
    for (int i = 0; i < KMaxCount; i++) {
        ...
        [btn setTitleColor:[_colornumber integerValue]==1?[UIColor whiteColor]:KMainColor forState:UIControlStateSelected];
        [btn setBackgroundImage:[self imageWithColor:[_colornumber integerValue]==1?klightgreencolor:KbackColor] forState:UIControlStateHighlighted];
        [btn setBackgroundImage:[self imageWithColor:[_colornumber integerValue]==1?klightgreencolor:KbackColor] forState:UIControlStateSelected];
    ...
    [sureBtn setTitleColor:[_colornumber integerValue]==1?klightgreencolor:KMainColor forState:UIControlStateNormal];
    ...
    [cancelBtn setTitleColor:[_colornumber integerValue]==1?klightgreencolor:KMainColor forState:UIControlStateNormal];
...
- (void)show:(NSNumber *)number 
{
    [UIView animateWithDuration:0.3f animations:^{
        self.frame = CGRectMake(0, 140, self.bounds.size.width, self.bounds.size.height);
    }];
}
